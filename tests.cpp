...
TEST(VertiWordTest,MatchTreePlaceNFind)
{
    ...
    MatchTreeNode  nodeC = MatchTreeNode(2,6,0,c,c,tree.getLeaves());
    node->addChild(&nodeC);
    MatchTreeNode nodeC2  = MatchTreeNode(2,5,0,c,c,tree.getLeaves());
    node->addChild(&nodeC2);
    MatchTreeNode nodeCC = MatchTreeNode(3,1,0,c,c,tree.getLeaves());
...
TEST(VertiWordTest,testBasicMatchtree)
{
    ...
    MatchTreeNode child2_2 = MatchTreeNode(4,5,0,c,c,tree2.getLeaves());
...
TEST(VertiWordTest,extractMatch)
{
    ...
    MatchTreeNode child1 = MatchTreeNode(1,0,0,c,c,tree.getLeaves());
    MatchTreeNode child1_1 = MatchTreeNode(2,0,0,c,c,tree.getLeaves());
